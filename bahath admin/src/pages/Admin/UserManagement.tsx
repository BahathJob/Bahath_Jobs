  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Job Seeker Management</h1>
          <p className="text-gray-600">Manage all platform Job Seekers and their activities</p>
        </div>
        {/* <Button>
